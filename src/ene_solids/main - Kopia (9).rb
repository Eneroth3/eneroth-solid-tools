...
#to_subtract.make_unique if to_subtract.is_a? Sketchup::ComponentInstance#NOTE: to_subtract should be made unique, without littering the component browser. same with to_add.
    original_ents = entities_from_group_or_componet original
