...
# Known Issues:
#  * Subtract wont work if solid to subtract has faces lying on the faces in original solid.
#    This is because intersect_with can't find coplanar faces.
#    Place the the solid to subtract slightly outside original as workaround.
...
class Solids
  ...
  def self.intersect(ent0, ent1)
    ...
    ents0.intersect_with false, ent0.transformation, ents1, ent1.transformation, true, ent1#NOTE: if possible, ignore nested groups and components here.
    ents0.intersect_with false, ent0.transformation, ent0, ent0.transformation, true, ent1#NOTE: the extra two passes slows down execution. place results in separate group and copy into each context to explode there?
